...
description: "The core values that guide Future's Edge and its members."
sidebar:
  label: Values
  order: 5
tags: []
...
### What does the organization stand for? What does it stand against?
